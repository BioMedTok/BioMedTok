...
from transformers import EarlyStoppingCallback, AutoModelForTokenClassification, DataCollatorForTokenClassification, TrainingArguments, Trainer
...
def main():
    ...
    if "sentencepiece" in args.model_name:
        from transformers import CamembertTokenizerFast
        tokenizer = CamembertTokenizerFast.from_pretrained(args.model_name)
    else:

...
def main():
    ...
    if "sentencepiece" in args.model_name:
        ...
        tokenizer = CamembertTokenizer.from_pretrained(args.model_name, use_fast=True)
    else:
    ...
    output_name = f"DrBenchmark-FrenchMedMCQA-cls-{str(uuid.uuid4().hex)}"
